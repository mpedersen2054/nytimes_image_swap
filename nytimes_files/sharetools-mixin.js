    ...
    var ShareToolsMixin = {
        ...
        **/
        getDataAttrs: function (showAll, customDataAttr) {
            ...
            // ApOnline and Reuters articles will not have reprints for licensing reasons
            if ( showAll && (config.common.defaultUrl.indexOf('aponline') > -1 || config.common.defaultUrl.indexOf('reuters') > -1 )) {
