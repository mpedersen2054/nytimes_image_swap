        ...
        _.extend({}, ShareToolsMixin, {
            ...
            **/
            render: function () {
                ...
                // Sharetools masthead and left column are tested
                this.runABTest();
            ...
            **/
            ...
            /**
             * Changes the language on the masthead sharetools
             * and left side bar sharetools depending on the variant
             *
             *
             * @private
             * @method runABTest
             */
            runABTest: function () {
                var testName = 'articleSharetools';
                var isUserVariant = this.isUserVariant(testName);
                var $facebookText = $('.sharetools .facebook-sharetool .sharetool-text');
                var $twitterText = $('.sharetools .twitter-sharetool .sharetool-text');

                if (isUserVariant === '2' || isUserVariant === '3' || isUserVariant === '6' || isUserVariant === '7') {

                    if ($facebookText.text() === 'facebook') {
                        $facebookText.text('share');
                    }

                    if ($twitterText.text() === 'twitter') {
                        $twitterText.text('tweet');
                    }
                }

                if (isUserVariant === '4' || isUserVariant === '5' || isUserVariant === '6' || isUserVariant === '7') {
                    $('#sharetools-masthead .show-all-sharetool .sharetool-text').text('More');
                }
            }
